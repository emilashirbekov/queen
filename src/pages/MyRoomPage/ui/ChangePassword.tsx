...
import {changePassword, getUserInfo,} from "@/pages/MyRoomPage/api/personalThunk";
...
const ChangePassword: React.FC = () => {
    ...
    return (
        <div className="w-[95%] md:container mx-auto">
            <div
                className="bg-secondary flex flex-col py-[40px] px-[50px] rounded-[30px] mt-[30px] md:mt-[123px] gap-y-[40px]">
