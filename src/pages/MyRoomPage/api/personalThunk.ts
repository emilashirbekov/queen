...
export const getUserInfo = createAsyncThunk<PersonalUser, undefined>(
  "personal/user",
  async () => {
...
export const changePersonalUser = createAsyncThunk<
  PersonalUser,
  PersonalUserMutation
>("personal/updateUser", async (user) => {
...
export const createFavourite = createAsyncThunk<
  ...
  number | undefined,
  { state: RootState }
>("personal/favourites", async (product, { getState }) => {
...
export const getFavourites = createAsyncThunk<Favourites[], undefined>(
  ...
  async () => {
    const response = await axiosApi.get<ListResponse<Favourites>>(
...
export const getOrders = createAsyncThunk<OrderResponse[]>(
  "orders/getAll",
  async () => {
    const response = await axiosApi.get<ListResponse<OrderResponse>>(
      "/account/history/by/user/",
    );
    return response.data.results;
  },
);
...
export const deleteFavouriteMain = createAsyncThunk<void, number>(
  "personal/deleteFavourite",
  async (id) => {
    await axiosApi.delete(`/products/delete/isfavorite/${id}/`);
  },
);

export const changePassword = createAsyncThunk<void, NewPassword>(
  "personal/changePassword",
  async (password) => {
    await axiosApi.patch("/account/change/password/", password);
  },
);
