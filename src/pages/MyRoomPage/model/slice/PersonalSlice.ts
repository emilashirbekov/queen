...
export const selectPersonalUser = (state: RootState) =>
  state.personal.personalUser;
export const selectPersonalUserLoading = (state: RootState) =>
  state.personal.personalUserLoading;
...
export const selectOrdersLoading = (state: RootState) =>
  state.personal.ordersLoading;
export const selectOrder = (state: RootState) => state.personal.order;
export const selectNewPasswordLoading = (state: RootState) =>
  state.personal.newPasswordLoading;
