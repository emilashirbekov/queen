    ...
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          ...
          content="Магазин женской одежды Queen"
        />

        <meta name="og:title" content="Магазин женской одежды Queen" />
        <meta
          name="og:decription"
          content="Добро пожаловать в наш интернет-магазин женской одежды! У нас вы найдете стильные и модные вещи для любого случая.
